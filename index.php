...
<!-- HEllo This comment to check a github repository change or not -->
...
<head>
    ...
    <!-- <link rel="stylesheet" href="css/style.css?v=<?php echo time(); ?>">   This will force the css to relod  -->
...
<body class="home">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php">
                        <h3 style="color: white;" >FoodFrenzy</h3>
        ...
        <section class="hero bg-image" data-image-src="images/img/pimg-2.jpg">
            <!-- <img class="bg-image" src="images/img/pimg-2.jpg" alt=""> -->
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4 class="res-title">Featured Restaurants</h4> </div>
                    </div>
                    <div class="col-sm-8">
